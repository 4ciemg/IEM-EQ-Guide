...
![Normal ear gain with a bass boost (glide)](https://i.postimg.cc/NFhCkjQZ/zero2.png){width=200}
![Normal ear gain with flat bass](https://i.postimg.cc/NjbVvtxr/Proxima.png){width=200}
